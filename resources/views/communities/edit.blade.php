	...
	<div class="main-content">
		<section class="section">
			...
			<div class="section-body">
				<h2 class="section-title">Update Komunitas</h2>
				<div class="row">
					<div class="col-md-12">
						<div class="card">
                            <form action="{{ route('communities.update', ['id' => $data->id]) }}" method="POST">
                                {{ csrf_field() }}
								...
								<div class="card-body">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-sm-12 col-md-7">
											<textarea name="description" id="" cols="30" class="form-control" style="height: 200px !important;">{{ $data->description }}</textarea>
										</div>
									</div>
									<div class="form-group row mb-4">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-sm-12 col-md-7">
											<input type="text" class="form-control" name="contact_person" required value="{{ $data->contact_person }}">
										</div>
									</div>
									<div class="form-group row mb-4">
